  ...
  try {
    ...
    if (totalToClean === 0) {
      const cleanEmbed = new EmbedBuilder()
        ...
        .setFooter({ text: 'TNM Role Cleaner • Universal Server Guard', iconURL: 'https://www.shoptnm.org/favicon.png' });
    ...
    const finalEmbed = new EmbedBuilder()
      ...
      .setFooter({ text: 'TNM Role Management • Clean Verification System', iconURL: 'https://www.shoptnm.org/favicon.png' })
      .setTimestamp();
...
async function handleLegacyAccessRoleCleanup(guild, executor, replyCallback) {
  try {
    ...
    const embed = new EmbedBuilder()
      ...
      .setFooter({ text: 'TNM Access Management • Legacy Role Cleanup', iconURL: 'https://www.shoptnm.org/favicon.png' })
      .setTimestamp();
