...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('setrank')
    .setDescription('Set or change a player\'s rank in the TMN Roblox Group')
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`Successfully updated **${profile.displayName} (@${profile.username})** in **TMN | Trust No Mob**.`)
        .addFields(
        ...
        .setFooter({ text: 'TMN Group Management • 316559660', iconURL: 'https://xynfnagsss-hub.github.io/htbwshop/favicon.png' })
        .setTimestamp();
