...
function buildTicketSetupEmbed(useAttachment = false) {
  const embed = new EmbedBuilder()
    .setColor(0xF5AF19)
    .setAuthor({ name: 'TRUST NO MOB • 17,000+ COMMUNITY', iconURL: 'https://xynfnagsss-hub.github.io/tnmwshop/favicon.png' })
    ...
    .addFields(
      ...
      { name: '🌐 Web Marketplace', value: '[htbwshop.github.io](https://xynfnagsss-hub.github.io/tnmwshop/)', inline: true },
      { name: '🛡️ Staff Support', value: '24/7 active staff ready to assist you.', inline: false }
    )
    .setFooter({ text: 'TNM Support System • 17,000+ Members • Instant Delivery', iconURL: 'https://xynfnagsss-hub.github.io/tnmwshop/favicon.png' })
    .setTimestamp();
